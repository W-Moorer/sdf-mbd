...
using SurfaceSample = chrono::sdfcontact::ChSdfContactSurfaceSample;
using SurfaceGraph = chrono::sdfcontact::ChSdfContactSurfaceGraph;
using TriangleFace = chrono::sdfcontact::ChSdfTriangleFace;
using FieldSampleQuery = chrono::sdfcontact::ChSdfContactSampleQuery;
using chrono::sdfcontact::MakeSphereSurfaceGraph;
using chrono::sdfcontact::MakeTriangleMeshSurfaceGraph;
